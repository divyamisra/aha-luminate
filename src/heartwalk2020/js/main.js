  ...
  $(document).ready(function ($) {
    ...
    $('.js--header-zip-search').on('submit', function (e) {
      ...
      window.location.href =
        ...
        'SPageServer/?pagename=HeartWalk_Search&search_type=event&cross_event=' +
        (evID ? 'false' : 'true') +
        (evID ? '&fr_id=' + evID : '') +
        '&zip=' +
        zipSearched
    ...
    $('.js--header-walker-search').on('submit', function (e) {
      ...
      window.location.href =
        luminateExtend.global.path.secure +
        'SPageServer/?pagename=HeartWalk_Search&search_type=walker&cross_event=false&fr_id=' +
        evID +
        (firstName ? '&first_name=' + firstName : '') +
        (lastName ? '&last_name=' + lastName : '')
    })
    ...
    $('.js--header-team-search').on('submit', function (e) {
      ...
      window.location.href =
        luminateExtend.global.path.secure +
        'SPageServer/?pagename=HeartWalk_Search&search_type=team&cross_event=' +
        (evID ? 'false' : 'true') +
        (evID ? '&fr_id=' + evID : '') +
        '&team_name=' +
        teamName
                ...
                if (screenWidth >= 768) {
                  var eventRow =
                    ...
                    (acceptsRegistration === 'true'
                      ? '<a href="SPageServer/?pagename=heartwalk_register&fr_id=' +
                        event.id +
    ...
    if ($('body').is('.pg_entry')) {
      ...
      $('.js--greeting-team-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=HeartWalk_Search&search_type=team&cross_event=false&fr_id=' +
          evID +
          '&team_name=' +
          teamName
      })
              ...
              if (response.getPersonalVideoUrlResponse.videoUrl) {
                ...
                if (isProd) {
                  if (evID === 5612 || evID === 4854 || evID === 5731) {
                    ...
                    videoEmbedHtml =
                      '<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/YevRvej-dDk?wmode=opaque&amp;rel=0&amp;showinfo=0" title="American Heart Association Heart Walk Video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                  }
                } else {
