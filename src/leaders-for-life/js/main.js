...
;(function ($) {
  $(document).ready(function ($) {
        ...
        if (eventLocationURL === 'virtual' || eventLocationURL === 'Virtual') {
          ...
          if (company.eventlocationmapurl !== '') {
            ...
            if (eventMapLink.indexOf('http://') == 0 || eventMapLink.indexOf('https://') == 0 || eventMapLink.indexOf('www') == 0) {
              var companyMap =
                '<a target="_blank" aria-title="Google map for ' +
                company.companyname +
                ' location" href="' +
                eventMapLink +
                '">' +
                ...
                if (screenWidth >= 768) {
                  $('.js--participants-results-rows').append(
                    '<tr' +
                      ...
                      '</a></td><td></td><td></td><td class="col-cta text-right"><a href="' +
                  ...
                  $('.js--participants-results-rows')
                    ...
                    .append(
                      '<tr><td><table><tr' +
                        ...
                        ' ' +
                        participant.name.last +
                        '</a></td></tr><td></td></tr><tr><td></td><td></td></tr><tr><td colspan="2" class="text-center"><a href="' +
                        participant.donationUrl +
                  ...
                  $('.js--team-results-rows')
                    ...
                    .append(
                      '<tr><td><table><tr' +
                        ...
                        '">' +
                        team.name +
                        '</a></td></tr><tr><td></td><td></td></tr></td></tr><tr><td></td><td><a href="TR/?fr_id=' +
                        team.EventId +
                        '&pg=entry">' +
                        team.eventName +
    ...
    $('.js--header-company-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Leaders_For_Life_Search&search_type=company&cross_event=true&company=' + companySearched
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=company' +
    ...
    $('.js--header-zip-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Leaders_For_Life_Search&search_type=zip&cross_event=true&zip=' + zipSearched
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=zip' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&zip=' +
          zipSearched
      }
    ...
    $('.js--header-state-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Leaders_For_Life_Search&search_type=state&cross_event=true&state=' + stateSearched
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=state' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&state=' +
          stateSearched
      }
    ...
    $('#stateSearch').on('change', function () {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Leaders_For_Life_Search&search_type=state&cross_event=true&state=' + stateSearch
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=state' +
    ...
    $('.js--header-participant-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=participant&cross_event=true' +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=participant' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      }
    ...
    $('.js--header-team-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Leader_For_Life_General') || $('body').is('.pg_Leader_For_Life_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Leaders_For_Life_Search&search_type=team&cross_event=true&team_name=' + teamName
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=team' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&team_name=' +
          teamName
      }
...
*/
        ...
        $('.team-honor-list-row').each(function (i, donor) {
          ...
          $('.js--donor-roll').append(
            '<div ' +
              ...
              '"><span class="name">' +
              donorName +
              '</span><span class="amount"></span></div>'
          )
          if (i === 5) {
    ...
    if ($('body').is('.pg_entry')) {
      ...
      $('.js--greeting-participant-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=participant&cross_event=false&fr_id=' +
          evID +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      })
      ...
      $('.js--greeting-team-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Leaders_For_Life_Search&search_type=team&cross_event=false&fr_id=' +
          evID +
          '&team_name=' +
          teamName
      })
            ...
            success: function (response) {
              ...
              if (response.getPersonalVideoUrlResponse.videoUrl) {
                ...
                videoEmbedHtml =
                  ...
                  '" title="American Heart Association Leader For Life Video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              } else {
                // TODO - show default video
                videoEmbedHtml =
                  '<iframe cc_load_policy=1 width="560" height="315" src="https://www.youtube.com/embed/LryhjU1bEC4" title="About American Heart Association Leader For Life" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              }
                ...
                $(participants).each(function (i, participant) {
                  ...
                  if (participant.aTeamCaptain === 'true') {
                    $('.js--team-captain-link')
                      .attr('href', participant.donationUrl)
                      .attr('aria-lablel', 'Team Captain ' + participant.name.first + ' ' + participant.name.last + "'s fundraising page'")
                  }
                })
