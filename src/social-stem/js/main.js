  ...
  $(document).ready(function ($) {
    ...
    $('.js--header-company-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Stem_General') || $('body').is('.pg_Stem_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Stem_Search&search_type=company&cross_event=true&company=' + companySearched
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=company' +
    ...
    $('.js--header-zip-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Stem_General') || $('body').is('.pg_Stem_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=zip' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&zip=' +
          zipSearched
      }
    ...
    $('.js--header-state-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Stem_General') || $('body').is('.pg_Stem_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=state' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&state=' +
          stateSearched
      }
    ...
    $('.js--header-participant-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Stem_General') || $('body').is('.pg_Stem_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=participant&cross_event=true' +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=participant' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      }
    ...
    $('.js--header-team-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Stem_General') || $('body').is('.pg_Stem_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=team' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&team_name=' +
          teamName
      }
        ...
        callback: {
          success: function (response) {
            if (!$.isEmptyObject(response.getTeamSearchByInfoResponse)) {
              ...
              var teamListColumnLength =
                teamData.length > 5 && teamData.length < 11 ? 'two-column-team-list' : teamData.length > 10 ? 'three-column-team-list' : 'one-column-team-list'
              ...
              $(teamData).each(function (i) {
                ...
                var topTeamRow =
                  '<li class="' +
                  teamListColumnLength +
                  '"><div class="d-flex"><div class="flex-grow-1"><a href="TR/?team_id=' +
                  teamId +
                  '&amp;pg=team&amp;fr_id=' +
                  evID +
                  '">' +
    ...
    if ($('body').is('.pg_entry')) {
      ...
      $('.js--greeting-participant-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=Stem_Search&search_type=participant&cross_event=false&fr_id=' +
          evID +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      })
      ...
      $('.js--greeting-team-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=Stem_Search&search_type=team&cross_event=false&fr_id=' + evID + '&team_name=' + teamName
      })
            ...
            success: function (response) {
              ...
              if (response.getPersonalVideoUrlResponse.videoUrl) {
                ...
                videoEmbedHtml =
                  ...
                  '" title="American Heart Association STEM Video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              } else {
                // TODO - show default video
                videoEmbedHtml =
                  '<iframe cc_load_policy=1 width="560" height="315" src="https://www.youtube.com/embed/LryhjU1bEC4" title="About American Heart Association STEM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              }
