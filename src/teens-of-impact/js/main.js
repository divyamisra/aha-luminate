  ...
  $(document).ready(function ($) {
    ...
    $('.js--header-company-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=company&cross_event=true&company=' + companySearched
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=company' +
    ...
    $('.js--header-zip-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=zip' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&zip=' +
          zipSearched
      }
    ...
    $('.js--header-state-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=state' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&state=' +
          stateSearched
      }
    ...
    $('.js--header-participant-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=participant&cross_event=true' +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      } else {
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=participant' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      }
    ...
    $('.js--header-team-search').on('submit', function (e) {
      ...
      if ($('body').is('.pg_Toi_General') || $('body').is('.pg_Toi_Landing_Page')) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=team' +
          (evID ? '&cross_event=false&fr_id=' + evID : '&cross_event=true') +
          '&team_name=' +
          teamName
      }
    ...
    if ($('body').is('.pg_entry')) {
      ...
      $('.js--greeting-participant-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure +
          'SPageServer/?pagename=TOI_Search&search_type=participant&cross_event=false&fr_id=' +
          evID +
          (firstName ? '&first_name=' + firstName : '') +
          (lastName ? '&last_name=' + lastName : '')
      })
      ...
      $('.js--greeting-team-search-form').on('submit', function (e) {
        ...
        window.location.href =
          luminateExtend.global.path.secure + 'SPageServer/?pagename=TOI_Search&search_type=team&cross_event=false&fr_id=' + evID + '&team_name=' + teamName
      })
            ...
            success: function (response) {
              ...
              if (response.getPersonalVideoUrlResponse.videoUrl) {
                ...
                videoEmbedHtml =
                  ...
                  '" title="American Heart Association Teens of Impact Video" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              } else {
                // TODO - show default video
                videoEmbedHtml =
                  '<iframe cc_load_policy=1 width="560" height="315" src="https://www.youtube.com/embed/LryhjU1bEC4" title="About American Heart Association Teens of Impact" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
              }
                ...
                $(participants).each(function (i, participant) {
                  ...
                  if (participant.aTeamCaptain === 'true') {
                    $('.js--team-captain-link')
                      ...
                      .attr('aria-lablel', 'Team Captain ' + participant.name.first + ' ' + participant.name.last + "'s donation page'")
                  }
                })
